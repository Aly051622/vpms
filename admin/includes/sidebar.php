        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                    <a href="add-vehicle.php"> <i class="menu-icon fa fa-user-circle-o"></i>Register Client Vehicle </a>
                    </li>
                    <li>
                    <a href="manage-reg.php"> <i class="menu-icon fa fa-user-circle-o"></i>Manage Registered Client Vehicles </a>
                    </li>
