...
FROM (
    SELECT 
        tblqr_logout.ParkingSlot, 
        tblqr_logout.TIMEOUT AS FormattedInTime, 
    ...
    FROM 
        tblqr_logout 
    INNER JOIN 
        tblvehicle ON tblqr_logout.VehiclePlateNumber = tblvehicle.RegistrationNumber 
    LEFT JOIN 
        tblqr_login ON tblqr_logout.VehiclePlateNumber = tblqr_login.VehiclePlateNumber 
    WHERE 
        tblqr_logout.ID = '$cid'
    ...
    SELECT 
        tblmanual_logout.ParkingSlot, 
        tblmanual_logout.TimeOut AS FormattedInTime, 
        tblvehicle.VehicleCategory, 
        tblvehicle.VehicleCompanyname, 
        tblvehicle.Model, 
        tblvehicle.Color, 
    ...
    FROM 
        tblmanual_logout 
    INNER JOIN 
        tblvehicle ON tblmanual_logout.RegistrationNumber = tblvehicle.RegistrationNumber 
    LEFT JOIN 
        tblmanual_login ON tblmanual_logout.RegistrationNumber = tblmanual_login.RegistrationNumber 
    WHERE 
        tblmanual_logout.id = '$cid'
) AS CombinedResults";
...
if (!$result) {
  ...
  <head>
      ...
      <title>View Outgoing Detail | CTU Danao Parking System</title>
