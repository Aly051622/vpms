...
?>
    ...
    <div class="col-12 col-md-9 position-relative">
        <input 
            ...
            value=""
        >
        <i class="bi bi-eye-slash toggle-password" data-target="currentpassword" style="position: absolute; right: 30px; top: 50%; transform: translateY(-50%); cursor: pointer; font-weight: bold;"></i>
    </div>
</div>
...
<div class="row form-group">
    ...
    <div class="col-12 col-md-9 position-relative">
        ...
        >
        <i class="bi bi-eye-slash toggle-password" data-target="newpassword" style="position: absolute; right: 30px; top: 50%; transform: translateY(-50%); cursor: pointer;font-weight: bold;"></i>
    </div>
</div>
...
<div class="row form-group">
    ...
    <div class="col-12 col-md-9 position-relative">
        <input 
            ...
            value=""
        >
        <i class="bi bi-eye-slash toggle-password" data-target="confirmpassword" style="position: absolute; right: 30px; top: 50%; transform: translateY(-50%); cursor: pointer; font-weight: bold;"></i>
    </div>
</div>
