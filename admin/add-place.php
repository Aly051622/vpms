...
if (strlen($_SESSION['vpmsaid']==0)) {
  header('location:logout.php');
    ...
    if (isset($_POST['submit'])) {
        $vehicleplace = $_POST['vehicleplace'];
         
        $query = mysqli_query($con, "INSERT INTO tblplace (vehicleplace, creationDate) VALUES ('$vehicleplace', NOW())");
        
        if ($query) {
            echo "<script>alert('Vehicle Place added successfully');</script>";
...
<head>
    ...
    <title>Add Category | CTU Danao Parking System </title>
