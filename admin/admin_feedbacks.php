                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title"> Client Feedbacks</strong>
                        </div>
                        <div class="card-body">
...
<script src="assets/js/main.js"></script>
    ...
    <script>
                ...
                .then(data => {
                    ...
                    if (data.success && Array.isArray(data.feedbacks) && data.feedbacks.length > 0) {
                        data.feedbacks.forEach(feedback => {
                            addFeedbackToUI(feedback.username || 'Anonymous', feedback.feedback);
                        });
                    } else {
                        // Display no feedback message
                        feedbackSection.innerHTML = `
                            <div class="no-feedback-alert">
        ...
        // Helper function to add feedback to the UI
        function addFeedbackToUI(userName, feedbackText) {
            const feedbackSection = document.getElementById('feedback-section');
