...
if(isset($_POST['submit']))
{
    ...
    $query = mysqli_query($con, "UPDATE tblguard SET Password='$password' WHERE Email='$email' AND MobileNumber='$contactno'");
...
<body class="bg-dark">
    ...
    echo $msg;
                       ...
                       <input type="password" class="form-control" id="newpassword" name="newpassword" placeholder="New Password" required="true">
                        <i class="fa fa-eye-slash" id="togglePassword" style="position: absolute; right: 10px; top: 6px; cursor: pointer; color: black;"></i>
                        ...
                        <i class="fa fa-eye-slash" id="toggleRepeatPassword" style="position: absolute; right: 10px; top: 6px; cursor: pointer; color: black;"></i> 
                          </div>
                        <div class="checkbox">
