...
<body class="bg-dark">
    ...
    echo $msg;
                       ...
                       <input type="password" class="form-control" id="newpassword" name="newpassword" placeholder="New Password" required="true">
                        <i class="fa fa-eye-slash" id="togglePassword" style="position: absolute; right: 10px; top: 4px; cursor: pointer; color: black;"></i>
                        ...
                        <i class="fa fa-eye-slash" id="toggleRepeatPassword" style="position: absolute; right: 10px; top: 4px; cursor: pointer; color: black;"></i> 
                          </div>
                        <div class="checkbox">
